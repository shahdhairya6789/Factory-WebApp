...
public interface AttendanceRepository extends JpaRepository<Attendance, Integer> {
    ...
    @Query(value = "SELECT a.id AS attendanceId, a.attendance_date AS attendanceDate, a.production as production, a.dhaga as dhaga, " +
            "u.id AS userId, u.name AS userName, " +
            "s.id AS shiftId, s.name AS shiftName, " +
            "st.id AS salaryTypeId, st.name AS salaryType, " +
            ...
            "WHERE a.is_active = true and a.attendance_date between :startDate and :endDate and a.user_id = :userId", // Example condition to filter active attendance
            nativeQuery = true)
